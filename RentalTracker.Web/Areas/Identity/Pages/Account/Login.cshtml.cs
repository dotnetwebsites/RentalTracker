...
namespace RentalTracker.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (await _userManager.FindByNameAsync(Input.Email) != null)
                {
                    ...
                    //Input.Email = (await _userManager.FindByNameAsync(Input.Email)).UserName;
                }
                ...
                if (result.Succeeded)
                {
                    ...
                    user.IPAddress = Request.HttpContext.Connection?.RemoteIpAddress;
