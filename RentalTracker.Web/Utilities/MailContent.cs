namespace RentalTracker.Web.Utilities
{
    public class MailContent
    {
        ...
        public MailContent(string logoName, string title, string url, string buttonValue, string domainname, string address)
        {
            Content = @"<div><u></u><div 
                ...
                <a href='" + domainname + @"' style='color:#868e96!important;text-decoration:none;font-size:16px;font-weight:bold' target='_blank'> 
                <h2>" + logoName + @"</h2></a>
                ...
                " + logoName + @" <br>" + address + @"</p></td></tr></tbody></table></td></tr>
