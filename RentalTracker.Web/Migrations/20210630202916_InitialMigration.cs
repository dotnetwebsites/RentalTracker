        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlternateNo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "IN", "India", "SystemGenerated", new DateTime(2021, 7, 1, 1, 59, 13, 558, DateTimeKind.Local).AddTicks(2559), true, "IND", null, null });

            migrationBuilder.InsertData(
                table: "States",
                columns: new[] { "StateId", "CountryId", "CreatedBy", "CreatedDate", "IsActive", "ShortName", "StateCode", "StateName", "UpdatedBy", "UpdatedDate" },
                values: new object[] { 1, 1, "SystemGenerated", new DateTime(2021, 7, 1, 1, 59, 13, 567, DateTimeKind.Local).AddTicks(8122), true, "UP", "UP", "Uttar Prades", null, null });

            migrationBuilder.InsertData(
                table: "States",
                columns: new[] { "StateId", "CountryId", "CreatedBy", "CreatedDate", "IsActive", "ShortName", "StateCode", "StateName", "UpdatedBy", "UpdatedDate" },
                values: new object[] { 2, 1, "SystemGenerated", new DateTime(2021, 7, 1, 1, 59, 13, 569, DateTimeKind.Local).AddTicks(379), true, "MP", "MP", "Madhya Prades", null, null });
